...
static unsigned int lcdclk_ws24_v = 1; /* 4 for boost */
static unsigned int lcdclk_ws24_h = 1; /* 4 for boost */
static unsigned int lcdclk_s6d_v = 1; /* 6 for boost */
static unsigned int lcdclk_s6d_h = 1; /* 6 for boost */
