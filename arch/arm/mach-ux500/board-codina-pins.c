...
static pin_cfg_t codina_common_pins[] = {
	...
	GPIO16_GPIO		| PIN_OUTPUT_HIGH,	/* NC */
	GPIO17_GPIO		| PIN_OUTPUT_HIGH,	/* NC */
...
#else
	GPIO31_GPIO		| PIN_OUTPUT_LOW,	/* NFC FIRMWARE */
...
#else
	GPIO88_GPIO		| PIN_OUTPUT_LOW,	/* NFC ON */
#endif
...
#else
	GPIO151_GPIO | PIN_INPUT_NOPULL,	/* NFC_SCL_1V8 */
	GPIO152_GPIO | PIN_INPUT_NOPULL,	/* NFC_SDA_1V8 */
#endif
	GPIO153_GPIO | PIN_INPUT_PULLDOWN,	/* NC */
	GPIO154_GPIO | PIN_INPUT_PULLDOWN,	/* NC */
	GPIO155_GPIO | PIN_INPUT_PULLDOWN,	/* NC */
