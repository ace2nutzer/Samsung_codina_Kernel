...
static DEF_PRCMU_CLK(sgaclk, PRCMU_SGACLK, 449280000);
...
static DEF_PRCMU_CLK(per7clk, PRCMU_PER7CLK, 56160000);
...
static DEF_PRCMU_CLK(mcdeclk, PRCMU_MCDECLK, 159744000);
static DEF_PRCMU_OPP100_CLK(ipi2cclk, PRCMU_IPI2CCLK, 24000000);
static DEF_PRCMU_CLK(dsialtclk, PRCMU_DSIALTCLK, 399360000);
